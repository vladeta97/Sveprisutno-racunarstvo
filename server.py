...
ENDPOINT_TOKEN = "token3"      
APPLICATION_VERSION = "cam2dj0n7nk35lgijrjg-meteostanica"  

with open('BWS.csv', mode='r') as csv_file:
...
class DataCollectionClient:
    ...
    def compose_data_sample(self, COUNT):
...
def main():
    ...
    while listener.keepRunning:
        COUNT+=1
        payload = data_collection_client.compose_data_sample(COUNT)
